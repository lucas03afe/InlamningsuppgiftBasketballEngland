...
public class RegisterSteps {
    ...
    public void oppnar_registreringssidan() {
        ...
        webDriver.get("https://membership.basketballengland.co.uk/NewSupporterAccount");
    ...
    public void fyll_i_for() {
        webDriver.findElement(By.id("member_firstname")).sendKeys("Lucas");
    }
    ...
    public void fyll_i_epost() {
        webDriver.findElement(By.id("member_emailaddress")).sendKeys("test@mailnesia.com");
        webDriver.findElement(By.id("member_confirmemailaddress")).sendKeys("test@mailnesia.com");
    }
